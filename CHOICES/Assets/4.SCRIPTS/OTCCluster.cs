...
public class OTCCluster : MonoBehaviour
{
    ...
    public OTCLookupTable.SPREAD_SHAPE forcedShape = OTCLookupTable.SPREAD_SHAPE.NONE;
    [Header("Internals")]
    ...
    void Start()
    {
        ...
        GameObject newPool = new GameObject("ClusterBounds", typeof(ObjectPool));
        clusterPool = newPool.GetComponent<ObjectPool>();
    ...
    public void spread(OTCLookupTable iOTCTable, float iOTC_Factor)
    {
        ...
        if (forcedShape!=OTCLookupTable.SPREAD_SHAPE.NONE)
            iOTCTable.ComputeSpreadShape(this, iOTC_Factor, forcedShape);
        else
